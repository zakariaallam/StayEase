        ...
        <div class="absolute inset-0 hero-shadow flex flex-col justify-between p-4 md:p-10">
            ...
            <div class="text-white max-w-4xl">
                <div class="flex items-center gap-2 mb-3">
                    <span
                        class="bg-indigo-600 text-[10px] font-black px-3 py-1 rounded-md uppercase tracking-tighter">Premium
                        Selection</span>
        ...
        <div class="grid lg:grid-cols-3 gap-12">
                ...
                <section>
                    ...
                    <div class="space-y-4">
                        @forelse($hotel->rooms as $room)
                            <div
                                class="flex flex-col sm:flex-row bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-indigo-300 transition-colors group">
                                ...
                                <div class="flex-1 p-5 flex flex-col justify-between">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p class="text-slate-500 text-xs mt-1 line-clamp-1">{{ $room->description }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-end justify-between mt-4">
                                        <div>
                                            <span
                                                class="text-indigo-600 font-bold text-lg">{{ $room->price_per_night }}
                                                DH</span>
                                            <span class="text-slate-400 text-[10px] block">/ Nuit</span>
                                        </div>
                                        @auth
                                            <a href="{{ route('reserv.index', $room->id) }}"
                                                class="bg-slate-900 text-white text-xs font-bold px-4 py-2 rounded-lg hover:bg-indigo-600 transition-colors">
                                                Réserver
                                            </a>
                                        @endauth
                                    </div>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-24 bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-6">
                    ...
                    <button
                        class="w-full bg-indigo-600 text-white font-bold py-4 rounded-2xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100">
