    ...
    <nav class="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 py-4">
        <div class="max-w-5xl mx-auto px-4 flex justify-between items-center">
            <a href="{{ route('hotels.index') }}"
                class="group flex items-center gap-2 text-slate-500 hover:text-indigo-600 transition-all">
            ...
            <div class="flex gap-3">
                <a href="{{ route('hotels.edit', $hotel->id) }}"
                    class="px-4 py-2 bg-amber-50 text-amber-600 rounded-xl font-bold text-sm hover:bg-amber-500 hover:text-white transition-all">
                    Modifier
                </a>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            @forelse($hotel->images as $img)
                                <div class="group relative h-40 rounded-2xl overflow-hidden shadow-sm">
