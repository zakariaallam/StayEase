...
<body class="bg-white dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-100 antialiased font-sans hero-gradient">
    ...
    <header class="fixed top-0 left-0 right-0 z-50 glass-effect border-b border-slate-200/60 dark:border-white/10">
        <nav class="max-w-7xl mx-auto px-8 h-16 flex items-center justify-between">
            ...
            <div
                class="hidden lg:flex items-center gap-10 text-[13px] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400">
            ...
            <div class="flex items-center gap-6">
                ...
                @auth
                    <div class="flex items-center gap-4">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-red-500 transition-all">
                                Logout
                            </button>
                        </form>
                    </div>
                @else
                    <a href="{{ route('login') }}"
                        class="text-xs font-bold uppercase tracking-widest hover:text-primary dark:hover:text-white transition-all">
                        Login
                    </a>
                @endauth

                <button
                    class="bg-primary dark:bg-white text-white dark:text-black px-6 py-2 rounded-sm text-xs font-bold uppercase tracking-widest transition-all hover:bg-slate-800 dark:hover:bg-slate-200 shadow-sm">
                    Book Now
                </button>
            </div>
        </nav>
    ...
    <main class="pt-32">
        ...
        <section class="max-w-7xl mx-auto px-8 mb-24">
            <div class="text-center max-w-4xl mx-auto mb-16">
                ...
                <h1
                    class="text-4xl md:text-6xl font-bold tracking-tight mb-8 leading-[1.15] text-slate-900 dark:text-white">
                    Refined stays for the <br><span class="italic font-normal text-slate-500">discerning</span>
                    traveler.
                </h1>
            ...
            @auth
                <div class="max-w-6xl mx-auto">
                    <div
                        class="bg-white dark:bg-zinc-900 rounded-xl shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-slate-200 dark:border-white/5 flex flex-col md:flex-row items-stretch p-2">
                        <div
                            class="flex-1 flex flex-col justify-center px-8 py-4 border-b md:border-b-0 md:border-r border-slate-100 dark:border-white/5">
                            <span
                                class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">Destination</span>
                            <input type="text" placeholder="Search cities or hotels"
                                class="bg-transparent focus:outline-none placeholder:text-slate-300 font-medium text-sm text-slate-900 dark:text-white">
                        </div>
                        <div
                            class="flex-1 flex flex-col justify-center px-8 py-4 border-b md:border-b-0 md:border-r border-slate-100 dark:border-white/5">
                        ...
                        <div
                            class="flex-1 flex flex-col justify-center px-8 py-4 border-b md:border-b-0 md:border-r border-slate-100 dark:border-white/5">
                            <span
                                class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">Departure</span>
                            <input type="text" placeholder="Select date"
                                class="bg-transparent focus:outline-none placeholder:text-slate-300 font-medium text-sm text-slate-900 dark:text-white">
                        </div>
                        <div class="flex-1 flex flex-col justify-center px-8 py-4">
                            <span
                                class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">Occupancy</span>
                            <input type="text" placeholder="2 Guests"
                                class="bg-transparent focus:outline-none placeholder:text-slate-300 font-medium text-sm text-slate-900 dark:text-white">
                        </div>
                        <button
                            class="bg-primary dark:bg-white text-white dark:text-black px-10 py-4 md:py-0 rounded-lg font-bold text-sm uppercase tracking-widest transition-all hover:bg-opacity-90">
                            Search
                        </button>
                    </div>
                </div>
        ...
        <section class="max-w-7xl mx-auto px-8 mb-32">
            <div class="flex items-end justify-between mb-12">
                <div>
                    <span class="text-[11px] font-bold uppercase tracking-[0.2em] text-indigo-600 mb-2 block">Curation
                        01</span>
                    <h2 class="text-3xl font-bold tracking-tight">The Season's Best</h2>
                </div>
                <button
                    class="group flex items-center gap-2 text-xs font-bold uppercase tracking-widest border-b-2 border-slate-200 dark:border-white/10 pb-1 hover:border-primary dark:hover:border-white transition-all">
        ...
        <section
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-20">
                <div>
                    ...
                    <p class="text-slate-500 dark:text-slate-400 mb-8">We don't just list hotels; we vet them. Every
                        property in our collection is hand-selected by our travel experts based on design, service, and
                        soul.</p>
                    <button
    ...
    <footer class="bg-white dark:bg-[#0a0a0a] border-t border-slate-200 dark:border-white/10 pt-20 pb-12">
        <div class="max-w-7xl mx-auto px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
                ...
                <div>
                    <h5 class="text-[11px] font-bold uppercase tracking-widest text-slate-900 dark:text-white mb-6">
                        Company</h5>
