...
<head>
    ...
    <title>403 Forbidden | StayEasy</title>
    ...
    <main class="flex-grow flex items-center justify-center px-8 pt-16">
        <div class="max-w-2xl w-full text-center">
            ...
            <h1 class="text-5xl md:text-7xl font-bold tracking-tight mb-8 leading-tight">
                Access <span class="italic font-normal text-slate-400">Restricted</span>
            </h1>
            ...
            <p class="text-lg text-slate-500 dark:text-slate-400 leading-relaxed max-w-md mx-auto mb-12">
                This area of the StayEasy portfolio is reserved for authorized personnel only. Please verify your credentials to continue.
            </p>
