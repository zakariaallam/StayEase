                    ...
                    <form action="{{ route('rooms.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="number" class="form-control" placeholder="Ex: 101" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Prix par nuit (€)</label>
                                <input type="number" name="price_per_night" class="form-control" placeholder="0.00" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="capacity" class="form-control" placeholder="Nombre de personnes" required>
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary px-5 shadow-sm">Enregistrer la chambre</button>
                        </div>
                    </form>
                </div>
            </div>
