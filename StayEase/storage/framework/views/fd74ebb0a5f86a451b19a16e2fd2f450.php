...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
       ...
       <div class="row row-cols-1 justify-content-center row-cols-md-2 g-4">
        ...
        <form action="/Chambre/edit/<?php echo e($Chambre->id); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">numero chambre</label>
                <input type="text" name="numero" value="<?php echo e($Chambre->numero); ?>" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">description</label>
                <input type="text" name="description" value="<?php echo e($Chambre->description); ?>" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">image</label>
                <input type="text" name="image" value="<?php echo e($Chambre->image); ?>" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">statut</label>
                <input type="text" name="statut" value="<?php echo e($Chambre->statut); ?>" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">capacite</label>
                <input type="number" name="capacite" value="<?php echo e($Chambre->capacite); ?>" class="form-control">
            </div>
            <div class="mb-3">
...
<?php /**PATH C:\Users\Youcode\Desktop\StayEase\StayEase\resources\views//Chambre/edit.blade.php ENDPATH**/ ?>